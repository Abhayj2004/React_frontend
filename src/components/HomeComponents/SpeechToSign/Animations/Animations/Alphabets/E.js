export const E = (ref) => {
    ...
    animations.push(["mixamorigLeftHandThumb1", "rotation", "y", -Math.PI/3, "-"]);
    animations.push(["mixamorigLeftHandThumb2", "rotation", "y", Math.PI/6, "+"]);
    animations.push(["mixamorigLeftHandThumb3", "rotation", "y", Math.PI/7, "+"]);



    
    animations.push(["mixamorigLeftHand", "rotation", "z", Math.PI/7.5, "+"]);
