export const A = (ref) => {
    ...
    animations.push(["mixamorigRightHandThumb1", "rotation", "x", Math.PI/18, "+"]);
    animations.push(["mixamorigRightHandThumb2", "rotation", "y", -Math.PI/18, "+"]);
    ...
    animations.push(["mixamorigLeftHandThumb1", "rotation", "x", Math.PI/18, "+"]);
    animations.push(["mixamorigLeftHandThumb2", "rotation", "y", -Math.PI/18, "+"]);
